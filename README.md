...
* **Citation:** If using or referencing these papers:

  ```
  koo1140. (2025). [Paper Title]. GitHub repository: https://github.com/koo1140
  ```

* **License:** All works are licensed under **CC BY-SA 4.0**.

  * You must credit `koo1140` for any use.
...
* This repository is primarily for **authorial publication**.
* New papers, updates, and experimental results will be added regularly.
* Suggestions and discussions are welcome via GitHub Issues, but all primary research remains authored by `koo1140`.
...
* GitHub: [https://github.com/koo1140](https://github.com/koo1140)
* Verification of authorship is possible through commit history and timestamps in this repository.
